...
from app.api.v1.endpoints import (
    ...
    historical_data, algo, instruments, screener, heatmap, news, market_data, stocks
)
...
for child in [
    ...
    historical_data.router, algo.router, instruments.router, screener.router, heatmap.router, news.router, market_data.router, stocks.router
]:

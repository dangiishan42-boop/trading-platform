...
from app.api.v1.endpoints import (
    ...
    historical_data, algo, instruments, screener, heatmap, news
)
...
for child in [
    ...
    historical_data.router, algo.router, instruments.router, screener.router, heatmap.router, news.router
]:
